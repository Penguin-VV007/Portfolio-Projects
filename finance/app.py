...
def buy():
    ...
    if request.method == "POST":
        ...
        if not symbol:
            ...
            return apology("Positive Shares is a must", 400)
        ...
        flash(f"Successfully Bought {shares} Shares of {symbol} Costing {usd(total_cost)}.")
        return redirect("/")
...
def register():
    ...
    if request.method == "POST":
        if not request.form.get("username"):
            return apology("Username is neccessary", 400)
        elif not request.form.get("password"):
            return apology("Password is neccessary", 400)
        elif not request.form.get("confirmation"):
            return apology("Password confirmation is neccessary", 400)
...
def sell():
    ...
    if request.method == "POST":
        ...
        if not symbol:
            ...
            return apology("Positive Number of Shares Mandatory", 400)
        else:
            shares = int(shares)
